...
This would be an additional rejection condition; it does not exempt a mode
...
The combined condition remains a proposal: production v8 and labels are
unchanged.
...
The user has not selected/adopted numerical thresholds yet.
