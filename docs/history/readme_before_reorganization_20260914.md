# README reference before documentation reorganization — 2026-09-14

This preserves the complete main README from commit
`aff23932fc825474e8620b22cb342bd0f052e8fb`, including its model metrics,
version history, audit links, setup recipes, gate details, and commands.
The original body follows without content removal; relative Markdown links
have been rebased to work from this directory.

For current instructions, start with the [main README](../../README.md),
[getting-started guide](../getting_started.md), and
[platform setup](../platforms.md). This dated reference contains superseded
claims, including a Flux AI environment presented as general setup, earlier
preset descriptions, and older pilot counts. Its quoted test results are
historical receipts, not checks performed during this documentation change.
The complete [project state](../project_state.md) remains in its original
location and is unchanged by this reorganization.
