...
- Staged lists not yet merged:
    ...
    - `training_labels/tae_like_nstx_135388.csv`: refreshed `nstx_135388`
      TAE-like labels, relative paths, accepted for training, not merged
    - `training_labels/tae_like_nstxuG121123J38.csv`: new
      `nstxuG121123J38` TAE-like labels, relative paths, accepted for
      training, not merged
...
training. When merging, replace the older `nstx_135388` entries already present
in the active 10-shot training list, and add `nstxuG121123J38` as a new shot.
