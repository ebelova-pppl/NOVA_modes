...
def default_train_csv() -> str:
    ...
    return str(repo_root / "training_labels" / "tae_like_v2_nonG.csv")
...
def parse_args() -> Config:
    ...
    ap.add_argument(
        ...
        help="Training CSV with mode paths and good/bad labels (default: $NOVA_TRAIN_CSV or training_labels/tae_like_v2_nonG.csv)",
    )
    ap.add_argument(
        "--data_dir",
