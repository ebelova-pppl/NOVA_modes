"""
Legacy one-off RF feature debugging script.

Archived because its hardcoded mode path and pre-schema-metadata workflow do
not track the current production RF feature schema.
"""
