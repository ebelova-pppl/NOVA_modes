...
class EaeRoutingTests(unittest.TestCase):
    ...
    def test_frozen_v5_preserves_old_routing_and_gates(self):
        ...
        self.assertIsNone(old_kwargs.pop("distributed_noise_top2_min"))
        self.assertEqual(new_kwargs.pop("distributed_noise_top2_min"), 0.005)
        self.assertIsNone(old_kwargs.pop("edge_secondary_peak_energy_min"))
        self.assertEqual(new_kwargs.pop("edge_secondary_peak_energy_min"), 0.5)
        self.assertIsNone(old_kwargs.pop("interior_envelope_footprint_spikes_fraction_max"))
        self.assertEqual(new_kwargs.pop("interior_envelope_footprint_spikes_fraction_max"), 0.5)
